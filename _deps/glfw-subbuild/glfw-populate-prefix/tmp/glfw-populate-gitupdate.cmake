...
execute_process(
  COMMAND "/bin/git" show-ref 3.3.7
  WORKING_DIRECTORY "/home/arthur/Desktop/cpp mg/_deps/glfw-src"
...
# yet).
execute_process(
  COMMAND "/bin/git" rev-list --max-count=1 3.3.7
  WORKING_DIRECTORY "/home/arthur/Desktop/cpp mg/_deps/glfw-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/arthur/Desktop/cpp mg/_deps/glfw-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/arthur/Desktop/cpp mg/_deps/glfw-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
